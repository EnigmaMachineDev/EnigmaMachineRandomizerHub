document.addEventListener('DOMContentLoaded', () => {
    ...
    function initializeOptions(data) {
        ...
        Object.keys(data.weapons).forEach(weapon => {
            addOption('weapons', weapon, weapon);
        });
        
        // Armor (all types combined)
        addCategory('Armor');
        data.armor.light.forEach(armor => {
            addOption('armor', armor.name, armor.name);
        });
        data.armor.medium.forEach(armor => {
            addOption('armor', armor.name, armor.name);
        });
        data.armor.heavy.forEach(armor => {
            addOption('armor', armor.name, armor.name);
        });
    }
